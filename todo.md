...
- [ ] Task 4: Implement model groups for compositing multiple child models into a single list item
- [ ] Task 5: Implement typed controllers for data-driven model building with 1-4 type parameters
